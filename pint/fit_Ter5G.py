...
parfile = os.path.join(datadir, 'Ter5G1.par')
...
t0.select(t0.get_mjds() > 53560 * u.d)#t0 = graphed
t0.select(t0.get_mjds() < 53600 * u.d)
...
for i in range(iter):
    ...
    print(minMJD, maxMJD)
    x = make_toas(minMJD-((maxMJD-minMJD)*3),maxMJD+((maxMJD-minMJD)*3),100,mrand)
